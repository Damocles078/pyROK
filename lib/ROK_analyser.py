            ...
            if(not self.queue.qsize() == 0):
                ...
                try:
                    if self.acquire_name:
                        name = self.acquire_name_from_img(image2[275:315, 620:860])
                    else:
                        name = "Not Acquired"
                except:
                    name = "failed"
                ...
                try:
                    if self.acquire_power:
                        power = self.acquire_power_from_img(image2[270:315, 980:1150])
                    else:
                        power = -1
                except:
                    power = -2
                ...
                try:
                    if self.acquire_alliance:
                        alliance = self.acquire_alliance_from_img(image1[465:495,820:920])
                    else:
                ...
                try:
                    if self.acquire_T4:
                        t4 = self.acquire_T4_from_img(image1[770:795, 1010:1220])
                    else:
                        t4 = -1
                except:
                    t4 = -2
                ...
                try:
                    if self.acquire_T5:
                        t5 = self.acquire_T5_from_img(image1[810:835, 1010:1220])
                    else:
                        t5 = -1
                except:
                    t5 = -2
                ...
                try:
                    if self.acquire_dead:
                        dead = self.acquire_dead_from_img(image2[535:565, 1200:1400])
                    else:
                        dead = -1
                except:
                    dead = -2
                ...
                try:
                    if self.acquire_rssAssist:
                        rssAssist = self.acquire_rssAssist_from_img(image2[725:760, 1200:1400])
                    else:
                        rssAssist = -1
                except:
                    rssAssist = -2
